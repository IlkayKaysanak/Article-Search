...
"""
    ...
    """
    response = model.generate_content(f"Metinde verceğim kısım bir akademik makale ben senin bu makaleyi okuyup bana şu şekilde json formatında döndürmeni istiyorum. {jsonformatım2} Formatımın başlıkları ve düzeni bu düzenini bozmadan doldurup bana bir dizi olarak geri döndür. . Metin : {text}  ")
